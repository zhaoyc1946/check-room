...
--
-- Host: localhost    Database: check-room
-- ------------------------------------------------------
...
CREATE TABLE `sys_dept` (
  ...
  `statues` tinyint(2) NOT NULL DEFAULT '1' COMMENT '状态  0：已删除  1: 正常',
  PRIMARY KEY (`dept_id`)
...
CREATE TABLE `sys_menu` (
  ...
  `type` tinyint(2) NOT NULL DEFAULT '0' COMMENT '类型 0 目录 1 菜单 2 按钮',
...
CREATE TABLE `sys_user` (
  ...
  `status` tinyint(2) NOT NULL COMMENT '状态: 0禁用, 1正常',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`user_id`)
...
CREATE TABLE `sys_user_role` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_Reference_16` (`user_id`) USING BTREE
...
CREATE TABLE `tb_token` (
  ...
  `token` varchar(32) NOT NULL COMMENT '验证token',
  `update_time` datetime NOT NULL COMMENT '更新时间',
  `expire_time` datetime NOT NULL COMMENT '过期时间',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户token验证表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-07-18 22:33:03
